...
class analysis():
    ...
    def run(self):
        ...
        df2 = (self.df
               ...
               .Define("MC_PrimaryVertex",  "FCCAnalyses::get_EventPrimaryVertex(21)( Particle )" )
               ...
               .Define("Bs2DsK_indices", "FCCAnalyses::get_indices( -531, {431, -321}, false, false, false, false) ( Particle, Particle1)" )
	       ...
	       # the angle between the MC Ds and the MC K
               .Define("Angle_DsK",  "FCCAnalyses::AngleBetweenTwoMCParticles( Ds, BachelorK ) ")
	       ...
	       # their energies
               .Define("Kplus_E",  "FCCAnalyses::get_e( Kplus )")
               .Define("Kminus_E",  "FCCAnalyses::get_e( Kminus )")
	       .Define("Piplus_E",   "FCCAnalyses::get_e( Piplus )")


               # the Ds kinematics 
               .Define("Ds_E",  "FCCAnalyses::get_e( Ds )")
               .Define("Ds_pt", "FCCAnalyses::get_pt( Ds ) ")
               .Define("Ds_theta", "FCCAnalyses::get_theta( Ds )")
               .Define("Ds_phi", "FCCAnalyses::get_phi( Ds )")

               # the bachelor K kinematics
               .Define("BachelorK_E",  "FCCAnalyses::get_e( BachelorK )")
               .Define("BachelorK_theta",  "FCCAnalyses::get_theta( BachelorK )")
               .Define("BachelorK_phi",  "FCCAnalyses::get_phi( BachelorK )")
	       ...
	       # Try to better account for the covariance matrix of the Ds pseudo-track
               ...
               .Define("Kplus_phi",  "FCCAnalyses::get_phi( Kplus )")
