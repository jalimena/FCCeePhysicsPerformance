...
class analysis():
	...
	#__________________________________________________________
		...
		#OVERVIEW: Accessing different objects and counting them
                ...
                .Define("FSGen_DeltaR", "if (n_FSGenElectron>1) return (FCCAnalyses::MCParticle::DeltaRBetweenTwoMCParticles(FSGenElectron.at(0),FSGenElectron.at(1))); else return float(-1.)")
